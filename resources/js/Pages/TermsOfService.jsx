...
export default function TermsOfService({ page = null }) {
    return (
        <LegalPage title="Terms of Service" lastUpdated="August 2026" page={page} badge={null}>
            <p>
                Welcome to <strong>RMS Educational Consultancy Ltd</strong>. By accessing our website or using our counseling, university placement, and visa advisory services, you agree to comply with and be bound by the following Terms of Service.
            </p>
            ...
            <p>
                All website design, text, graphics, logos, and software content belong exclusively to RMS Educational Consultancy Ltd. Unauthorized duplication or distribution is strictly prohibited.
            </p>
        </LegalPage>
    );
}
